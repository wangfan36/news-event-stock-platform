...
def normalize_news_item(raw_item: dict[str, Any], run_clock: datetime) -> dict[str, Any]:
    ...
    published_offset_hours = int(raw_item.get("published_offset_hours", 0) or 0)
    ...
    return {
        ...
        "published_at": (run_clock - timedelta(hours=published_offset_hours)).isoformat(timespec="minutes"),
        "tags": tags,
